...
pub fn derive_memory_descriptor_flags<T: MemoryDescriptorValidator>(desc: &T) -> PageTableFlags {
...
pub unsafe fn map_available_memory_to_higher_half<T: MemoryDescriptorValidator>(
    mapper: &mut OffsetPageTable,
    frame_allocator: &mut BootInfoFrameAllocator,
    phys_offset: VirtAddr,
    memory_map: &[T],
...
pub fn map_stack_to_higher_half<T: MemoryDescriptorValidator>(
    mapper: &mut OffsetPageTable,
    frame_allocator: &mut BootInfoFrameAllocator,
    phys_offset: VirtAddr,
    memory_map: &[T],
...
pub unsafe fn map_memory_descriptors_with_config<T: MemoryDescriptorValidator, F>(
    mapper: &mut OffsetPageTable,
    frame_allocator: &mut BootInfoFrameAllocator,
    memory_map: &[T],
    config_fn: F,
