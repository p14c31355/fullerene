...
/// Helper to setup the framebuffer writer and register it globally
fn setup_framebuffer(fb_config: petroleum::common::uefi::FullereneFramebufferConfig) {
...
pub fn init_vga(_physical_memory_offset: x86_64::VirtAddr, _vga_virt_addr: usize) {
    ...
    let config = petroleum::FULLERENE_FRAMEBUFFER_CONFIG.get()
...
pub fn init_vga_legacy() {
    ...
    let vga_buffer = petroleum::graphics::text::VgaBuffer::with_address(
