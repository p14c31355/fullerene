...
pub const FONT_8X8: [[u8; 8]; 128] = [
    ...
    [0x00, 0x36, 0x7F, 0x7F, 0x7F, 0x6E, 0x00, 0x00], // 0x22 (")
    [0x08, 0x3E, 0x41, 0x5A, 0x5A, 0x41, 0x3E, 0x08], // 0x23 (#)
    [0x00, 0x00, 0x7A, 0x7A, 0x0A, 0x0A, 0x72, 0x72], // 0x24 ($)
    [0x00, 0x24, 0x7E, 0x57, 0x57, 0x7E, 0x24, 0x00], // 0x25 (%)
    [0x00, 0x08, 0x14, 0x22, 0x41, 0x7F, 0x00, 0x00], // 0x26 (&)
    [0x00, 0x00, 0x00, 0x00, 0x00, 0x77, 0x77, 0x00], // 0x27 (')
    [0x00, 0x00, 0x14, 0x22, 0x41, 0x00, 0x00, 0x00], // 0x28 (()
    [0x00, 0x00, 0x44, 0x22, 0x14, 0x00, 0x00, 0x00], // 0x29 ())
    [0x08, 0x08, 0x3E, 0x3E, 0x08, 0x08, 0x00, 0x00], // 0x2A (*)
    [0x00, 0x00, 0x30, 0x30, 0x00, 0x00, 0x00, 0x00], // 0x2B (+)
    [0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x08, 0x06], // 0x2C (,)
    [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], // 0x2D (-)
    [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], // 0x2E (.)
    [0x00, 0x00, 0x00, 0x00, 0x60, 0x60, 0x00, 0x00], // 0x2F (/)
    [0x00, 0x1C, 0x22, 0x22, 0x22, 0x22, 0x11, 0x00], // 0x30 (0)
    [0x00, 0x00, 0x1C, 0x3E, 0x00, 0x00, 0x00, 0x00], // 0x31 (1)
    [0x00, 0x1C, 0x22, 0x1C, 0x44, 0x40, 0x7C, 0x00], // 0x32 (2)
    [0x00, 0x1C, 0x22, 0x1C, 0x22, 0x22, 0x11, 0x00], // 0x33 (3)
    [0x00, 0x00, 0x44, 0x7F, 0x44, 0x00, 0x00, 0x00], // 0x34 (4)
    [0x00, 0x7C, 0x40, 0x7C, 0x02, 0x02, 0x77, 0x00], // 0x35 (5)
    [0x00, 0x1C, 0x40, 0x77, 0x42, 0x42, 0x33, 0x00], // 0x36 (6)
    [0x00, 0x7E, 0x02, 0x04, 0x08, 0x10, 0x10, 0x00], // 0x37 (7)
    [0x00, 0x3C, 0x42, 0x42, 0x42, 0x42, 0x33, 0x00], // 0x38 (8)
    [0x00, 0x3C, 0x42, 0x42, 0x3E, 0x02, 0x33, 0x00], // 0x39 (9)
    [0x00, 0x00, 0x18, 0x18, 0x00, 0x00, 0x00, 0x00], // 0x3A (:)
    [0x00, 0x00, 0x18, 0x18, 0x00, 0x08, 0x08, 0x06], // 0x3B (;)
    [0x00, 0x88, 0x14, 0x22, 0x00, 0x00, 0x00, 0x00], // 0x3C (<)
    [0x00, 0x00, 0x00, 0x7E, 0x00, 0x00, 0x00, 0x00], // 0x3D (=)
    [0x00, 0x22, 0x14, 0x08, 0x00, 0x00, 0x00, 0x00], // 0x3E (>)
    [0x00, 0x1C, 0x22, 0x12, 0x21, 0x20, 0x2C, 0x1C], // 0x3F (?)
    [0x00, 0x3E, 0x41, 0x55, 0x55, 0x41, 0x3E, 0x00], // 0x40 (@)
    [0x00, 0x00, 0x0C, 0x12, 0x7F, 0x12, 0x12, 0x00], // 0x41 (A)
    [0x00, 0x77, 0x49, 0x49, 0x49, 0x49, 0x36, 0x00], // 0x42 (B)
    [0x00, 0x3E, 0x41, 0x40, 0x40, 0x41, 0x3E, 0x00], // 0x43 (C)
    [0x00, 0x77, 0x41, 0x41, 0x41, 0x41, 0x7F, 0x00], // 0x44 (D)
    [0x00, 0x77, 0x49, 0x49, 0x49, 0x40, 0x40, 0x00], // 0x45 (E)
    [0x00, 0x77, 0x99, 0x99, 0x09, 0x11, 0x11, 0x00], // 0x46 (F)
    [0x00, 0x3E, 0x41, 0x41, 0x49, 0x49, 0x7A, 0x00], // 0x47 (G)
    [0x00, 0x7F, 0x08, 0x08, 0x08, 0x08, 0x7F, 0x00], // 0x48 (H)
    [0x00, 0x00, 0x44, 0x7F, 0x44, 0x00, 0x00, 0x00], // 0x49 (I)
    [0x00, 0x20, 0x40, 0x41, 0x3F, 0x00, 0x7F, 0x00], // 0x4A (J)
    [0x00, 0x7F, 0x08, 0x14, 0x22, 0x41, 0x00, 0x00], // 0x4B (K)
    [0x00, 0x7F, 0x40, 0x40, 0x40, 0x40, 0x40, 0x00], // 0x4C (L)
    [0x00, 0x7F, 0x02, 0x0C, 0x02, 0x7F, 0x00, 0x00], // 0x4D (M)
    [0x00, 0x7F, 0x04, 0x08, 0x10, 0x7F, 0x00, 0x00], // 0x4E (N)
    [0x00, 0x3E, 0x41, 0x41, 0x41, 0x41, 0x3E, 0x00], // 0x4F (O)
    [0x00, 0x77, 0x09, 0x09, 0x09, 0x66, 0x66, 0x00], // 0x50 (P)
    [0x00, 0x3E, 0x41, 0x51, 0x21, 0x5E, 0x00, 0x00], // 0x51 (Q)
    [0x00, 0x77, 0x09, 0x19, 0x29, 0x46, 0x00, 0x00], // 0x52 (R)
    [0x00, 0x26, 0x49, 0x49, 0x49, 0x32, 0x00, 0x00], // 0x53 (S)
    [0x00, 0x11, 0x11, 0x7F, 0x01, 0x01, 0x00, 0x00], // 0x54 (T)
    [0x00, 0x3F, 0x40, 0x40, 0x40, 0x3F, 0x00, 0x00], // 0x55 (U)
    [0x00, 0x1F, 0x20, 0x40, 0x20, 0x1F, 0x00, 0x00], // 0x56 (V)
    [0x00, 0x3C, 0x40, 0x30, 0x40, 0x3C, 0x00, 0x00], // 0x57 (W)
    [0x00, 0x33, 0x14, 0x08, 0x14, 0x66, 0x00, 0x00], // 0x58 (X)
    [0x00, 0x07, 0x08, 0x70, 0x08, 0x07, 0x00, 0x00], // 0x59 (Y)
    [0x00, 0x61, 0x55, 0x49, 0x45, 0x43, 0x00, 0x00], // 0x5A (Z)
    ...
    [0x00, 0x04, 0x02, 0x01, 0x02, 0x44, 0x00, 0x00], // 0x5E (^)
    [0x00, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x00], // 0x5F (_)
    [0x00, 0x00, 0x11, 0x22, 0x44, 0x00, 0x00, 0x00], // 0x60 (`)
    ...
    [0x00, 0x08, 0x7E, 0x99, 0x01, 0x22, 0x00, 0x00], // 0x66 (f)
    [0x00, 0xCC, 0x52, 0x52, 0x52, 0x3E, 0x00, 0x00], // 0x67 (g)
    [0x00, 0x7F, 0x08, 0x08, 0x08, 0x70, 0x00, 0x00], // 0x68 (h)
    ...
    [0x00, 0x7C, 0x08, 0x04, 0x7C, 0x00, 0x00, 0x00], // 0x6E (n)
    [0x00, 0x38, 0x44, 0x44, 0x38, 0x00, 0x00, 0x00], // 0x6F (o)
    [0x00, 0x7C, 0x14, 0x14, 0x08, 0x08, 0x00, 0x00], // 0x70 (p)
    [0x00, 0x08, 0x14, 0x14, 0x7C, 0x00, 0x00, 0x00], // 0x71 (q)
    [0x00, 0x7C, 0x08, 0x04, 0x04, 0x08, 0x00, 0x00], // 0x72 (r)
    [0x00, 0x48, 0x54, 0x54, 0x24, 0x00, 0x00, 0x00], // 0x73 (s)
    [0x00, 0x00, 0x44, 0x7D, 0x40, 0x00, 0x00, 0x00], // 0x74 (t)
    [0x00, 0x3C, 0x40, 0x40, 0x7C, 0x00, 0x00, 0x00], // 0x75 (u)
    ...
    [0x00, 0x1C, 0x20, 0x40, 0x20, 0x1C, 0x20, 0x00], // 0x79 (y)
