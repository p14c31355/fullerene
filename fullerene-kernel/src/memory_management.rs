...
// Dummy implementations for logging macros to satisfy compilation
...
pub type SystemError = crate::SystemError;
pub type SystemResult<T> = crate::SystemResult<T>;
pub type PageFlags = crate::PageFlags;
