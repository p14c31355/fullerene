...
fn main() {
    ...
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_xbl_qmp_table)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_xbl_hsphy_table)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_no_smmu)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_dma_cache_maintenance)");
    ...
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_extended_setup_arm)"
    );
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_long_setup_arm)");
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_arm_window_recovery)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_clear_susphy_after_reset)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb3_link_training_after_reset)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_clear_susphy_after_runstop)"
    );
    ...
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_source_exact_runstop)"
    );
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_reassert_runstop)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_hold_runstop)");
    ...
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_separate_setup_buffer)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_clear_usb3_susphy_before_runstop)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_clear_usb3_susphy_after_runstop)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_reassert_device_mode)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_reassert_core_clocks)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_reassert_core_clocks_after_runstop)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_reassert_domain_after_runstop)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_reassert_link_clocks_after_runstop)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_android_dbm_reset)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_reassert_qmp_power)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_reassert_qmp_power_after_gctl)"
    );
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_reinit_hs_phy)");
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_pre_qmp_phy_setup)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_clear_qmp_autonomous)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_reassert_qmp_clocks)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_reassert_qmp_clocks_after_gctl)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_reassert_hs_phy_ref_after_gctl)"
    );
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_ref_after_gctl)");
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_dis_sleep_mode_before_gadget)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_clear_qmp_autonomous_exact)"
    );
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_qmp_resume_wmb)");
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_qmp_lfps_clear_wmb)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_qmp_notify_disconnect)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_clear_vbus_override_before_qmp)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_clear_keep_connect_before_stop)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_clear_usb3_susphy_before_qmp)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_disable_gadget_irq_before_stop)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_disable_ep0_before_stop)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_clear_gsi_stop_state)"
    );
    ...
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_preserve_ref_clock_state)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ss_preserve_phy_state)"
    );
    ...
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_gadget_start_only_at_runstop)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_gadget_speed_after_restart)"
    );
    println!(
    ...
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_reset_delay_150)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_auto_resume_pulse)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_start_after_reset)");
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_dalepena_after_reset)"
    );
    ...
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_hsphy_resume_clocks_after_reset)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_restore_suspend_n_after_runstop)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_restore_suspend_n_after_reset)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_restore_suspend_n_selected_after_runstop)"
    );
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_clear_sleepm)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_normal_opmode)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_clear_datapath_override)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_clear_power_down)");
    ...
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gctl_pwrdnscale_2)");
    ...
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_dcfg_fullspeed)");
    ...
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_source_devten_after_runstop)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_preserve_phy_interface)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_source_exact_runstop)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_source_phy_setup)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_runtime_power_keepalive)"
    );
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_dis_sleep_mode)");
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_source_peripheral_start)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_source_vbus_only)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_source_power_events)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_android_dbm_reset)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_ep0_trb_completion_fallback)"
    );
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_cmd_guard)");
    ...
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_source_resume_clocks)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_usb2_source_resume_core_reset)"
    );
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_core_hs_clock)");
    println!(
    ...
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_program_vdda_voltage)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_all_regulator_sets)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_write_barrier)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_ref_after_runstop)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_power_after_runstop)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_ignore_eud)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_disable_eud)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_vdd_lpm)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_hsphy_rtune)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_usb2_susphy_after_runstop)");
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_keep_connect_on_start)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_modern_dctl_preserve)"
    );
    println!(
        "cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_start_defaults_at_runstop)"
    );
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_gadget_handoff_min_runstop_delay)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_ss_phy_reset_release)");
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_android_block_reset)");
    ...
    println!("cargo:rustc-check-cfg=cfg(fullerene_aarch64_usb_probe_timer_event_poll)");
    ...
    if env::var("CARGO_CFG_TARGET_ARCH").as_deref() == Ok("aarch64") {
        ...
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_XBL_QMP_TABLE").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_xbl_qmp_table");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_XBL_HSPHY_TABLE").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_xbl_hsphy_table");
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_EXTENDED_SETUP_ARM").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_extended_setup_arm"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_LONG_SETUP_ARM").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_long_setup_arm");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_ARM_WINDOW_RECOVERY").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_arm_window_recovery"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_CLEAR_SUSPHY_AFTER_RESET")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_clear_susphy_after_reset"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB3_LINK_TRAINING_AFTER_RESET")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb3_link_training_after_reset"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_CLEAR_SUSPHY_AFTER_RUNSTOP")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_clear_susphy_after_runstop"
            );
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SOURCE_EXACT_RUNSTOP").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_source_exact_runstop");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_RUNSTOP").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_reassert_runstop");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_HOLD_RUNSTOP").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_hold_runstop");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_RETRY_SETUP").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_retry_setup");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_EAGER_SETUP").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_eager_setup");
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CORE_RESET_AT_RUNSTOP").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_core_reset_at_runstop"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_SEPARATE_SETUP_BUFFER").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_separate_setup_buffer"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_USB3_SUSPHY_BEFORE_RUNSTOP")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_clear_usb3_susphy_before_runstop"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_USB3_SUSPHY_AFTER_RUNSTOP")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_clear_usb3_susphy_after_runstop"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_DEVICE_MODE").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_reassert_device_mode"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_CORE_CLOCKS").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_reassert_core_clocks"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_CORE_CLOCKS_AFTER_RUNSTOP")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_reassert_core_clocks_after_runstop"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_DOMAIN_AFTER_RUNSTOP")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_reassert_domain_after_runstop"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_LINK_CLOCKS_AFTER_RUNSTOP")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_reassert_link_clocks_after_runstop"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_ANDROID_DBM_RESET").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_android_dbm_reset");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_QMP_POWER").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_reassert_qmp_power");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_QMP_POWER_AFTER_GCTL")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_reassert_qmp_power_after_gctl"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REINIT_HS_PHY").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_reinit_hs_phy");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_PRE_QMP_PHY_SETUP").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_pre_qmp_phy_setup");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_QMP_AUTONOMOUS").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_clear_qmp_autonomous"
            );
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_QMP_CLOCKS_AFTER_GCTL")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_reassert_qmp_clocks_after_gctl"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_HS_PHY_REF_AFTER_GCTL")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_reassert_hs_phy_ref_after_gctl"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_DIS_SLEEP_MODE_BEFORE_GADGET")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_dis_sleep_mode_before_gadget"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_QMP_AUTONOMOUS_EXACT")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_clear_qmp_autonomous_exact"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_QMP_RESUME_WMB").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_qmp_resume_wmb");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_QMP_LFPS_CLEAR_WMB").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_qmp_lfps_clear_wmb");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_QMP_NOTIFY_DISCONNECT").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_qmp_notify_disconnect"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_VBUS_OVERRIDE_BEFORE_QMP")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_clear_vbus_override_before_qmp"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_KEEP_CONNECT_BEFORE_STOP")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_clear_keep_connect_before_stop"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_USB3_SUSPHY_BEFORE_QMP")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_clear_usb3_susphy_before_qmp"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_DISABLE_GADGET_IRQ_BEFORE_STOP")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_disable_gadget_irq_before_stop"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_DISABLE_EP0_BEFORE_STOP").is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_disable_ep0_before_stop"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_GSI_STOP_STATE").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_clear_gsi_stop_state"
            );
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_PRESERVE_REF_CLOCK_STATE").is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_preserve_ref_clock_state"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_PRESERVE_PHY_STATE").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ss_preserve_phy_state");
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_GADGET_START_ONLY_AT_RUNSTOP")
            .is_some()
        {
            println!(
        ...
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_CLEAR_GSI_AFTER_RESET").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_clear_gsi_after_reset");
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_HSPHY_RESUME_CLOCKS_AFTER_RESET")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_hsphy_resume_clocks_after_reset"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_EUD_DEVICE_MODE").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_eud_device_mode");
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_NORMAL_OPMODE").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_normal_opmode");
        }
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_CLEAR_DATAPATH_OVERRIDE").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_clear_datapath_override");
        }
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_CLEAR_POWER_DOWN").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_clear_power_down");
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_POR_DELAY_150").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_por_delay_150");
        }
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_RESET_DELAY_150").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_reset_delay_150");
        }
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_AUTO_RESUME_PULSE").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_auto_resume_pulse");
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_EP0_RESET_CLEAR_TEST_MODE").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ep0_reset_clear_test_mode"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_EP0_RESET_CALLBACK_FIRST").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ep0_reset_callback_first"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_EP0_RESET_ANDROID_STATE_ORDER")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ep0_reset_android_state_order"
            );
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_SS_PHY_RESET_RELEASE").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_ss_phy_reset_release");
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_RESTORE_SUSPEND_N_AFTER_RESET").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_restore_suspend_n_after_reset");
        }
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_RESTORE_SUSPEND_N_SELECTED_AFTER_RUNSTOP")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_restore_suspend_n_selected_after_runstop"
            );
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_PROGRAM_VDDA_VOLTAGE").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_program_vdda_voltage");
        }
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_ALL_REGULATOR_SETS").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_all_regulator_sets");
        }
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_WRITE_BARRIER").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_write_barrier");
        }
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_REF_AFTER_RUNSTOP").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_ref_after_runstop");
        }
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_POWER_AFTER_RUNSTOP").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_power_after_runstop");
        }
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_REF_AFTER_GCTL").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_ref_after_gctl");
        }
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_IGNORE_EUD").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_ignore_eud");
        }
        if env::var_os("FULLERENE_AARCH64_USB_DISABLE_EUD").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_disable_eud");
        }
        if env::var_os("FULLERENE_USB_EUD_SCM_SKIP").is_some() {
            println!("cargo:rustc-env=FULLERENE_USB_EUD_SCM_SKIP=1");
        }
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_VDD_LPM").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_vdd_lpm");
        }
        if env::var_os("FULLERENE_AARCH64_USB_HSPHY_RTUNE").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_hsphy_rtune");
        }
        if env::var_os("FULLERENE_AARCH64_USB_USB2_SUSPHY_AFTER_RUNSTOP").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_usb2_susphy_after_runstop");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_KEEP_CONNECT_ON_START").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_keep_connect_on_start");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_MODERN_DCTL_PRESERVE").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_modern_dctl_preserve");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_START_DEFAULTS_AT_RUNSTOP").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_start_defaults_at_runstop"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_MIN_RUNSTOP_DELAY").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_min_runstop_delay");
        }
        ...
        if retry_clear && retry_set {
            panic!(
                "FULLERENE_AARCH64_USB_GUCTL3_USB20_RETRY_CLEAR and FULLERENE_AARCH64_USB_GUCTL3_USB20_RETRY_SET are mutually exclusive"
            );
        }
        if retry_clear {
        ...
        if env::var_os("FULLERENE_AARCH64_USB_GCTL_SOFITPSYNC_CLEAR").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gctl_sofitpsync_clear");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GCTL_PWRDNSCALE_2").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gctl_pwrdnscale_2");
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_DCFG_FULLSPEED").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_dcfg_fullspeed");
        }
        if env::var_os("FULLERENE_AARCH64_USB_DCFG_LOWSPEED").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_dcfg_lowspeed");
        }
        if env::var_os("FULLERENE_AARCH64_USB_NO_SS_VBUS").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_no_ss_vbus");
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_QPR1_UTMI_POST_RESET_ONLY")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_qpr1_utmi_post_reset_only"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_NO_USB2_RUNSTOP_GUARD").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_no_usb2_runstop_guard");
        }
        ...
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_DEVTEN_AFTER_RUNSTOP")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_source_devten_after_runstop"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_PRESERVE_PHY_INTERFACE").is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_preserve_phy_interface"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_EXACT_RUNSTOP").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_source_exact_runstop"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_PHY_SETUP").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_source_phy_setup");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_RUNTIME_POWER_KEEPALIVE")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_runtime_power_keepalive"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_DIS_SLEEP_MODE").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_dis_sleep_mode");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_PERIPHERAL_START")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_source_peripheral_start"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_VBUS_ONLY").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_source_vbus_only");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_POWER_EVENTS").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_source_power_events"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_ANDROID_DBM_RESET").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_android_dbm_reset");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_EP0_TRB_COMPLETION_FALLBACK").is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_ep0_trb_completion_fallback"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_CMD_GUARD").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_cmd_guard");
        }
        ...
        if let Ok(value) = env::var("FULLERENE_AARCH64_USB_GADGET_HANDOFF_QMP_LANE") {
            if matches!(value.as_str(), "a" | "b") {
                println!("cargo:rustc-env=FULLERENE_USB_QMP_LANE={value}");
            }
        }
        if let Ok(value) = env::var("FULLERENE_AARCH64_USB_GADGET_HANDOFF_QMP_PHASE_STOP") {
            if matches!(
                value.as_str(),
                "1" | "2" | "3" | "4" | "5" | "6" | "7" | "8"
            ) {
                println!("cargo:rustc-env=FULLERENE_USB_QMP_PHASE_STOP={value}");
            }
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_CLOCK_BRANCHES_REARM").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_clock_branches_rearm");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_RESUME_CLOCKS").is_some() {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_source_resume_clocks"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_RESUME_CORE_RESET")
            .is_some()
        {
            println!(
                "cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_usb2_source_resume_core_reset"
            );
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_CORE_HS_CLOCK").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_gadget_handoff_core_hs_clock");
        }
        if env::var_os("FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_FULL_CORE_RESET").is_some() {
        ...
        if env::var_os("FULLERENE_AARCH64_USB_PROBE_TIMER_EVENT_POLL").is_some() {
            println!("cargo:rustc-cfg=fullerene_aarch64_usb_probe_timer_event_poll");
        }
        ...
        if let Ok(value) = env::var("FULLERENE_AARCH64_USB_PREV_QMP_GATE") {
            println!("cargo:rustc-env=FULLERENE_USB_PREV_QMP_GATE={value}");
        }
        ...
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_XBL_QMP_TABLE");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_XBL_HSPHY_TABLE");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_LFPS_TIMER");
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_UX_EXIT_PX"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_HS_PHY_REF_AFTER_GCTL"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REINIT_HS_PHY"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_PRE_QMP_PHY_SETUP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_QMP_AUTONOMOUS_EXACT"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_QMP_RESUME_WMB"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_QMP_LFPS_CLEAR_WMB"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_QMP_NOTIFY_DISCONNECT"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_VBUS_OVERRIDE_BEFORE_QMP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_KEEP_CONNECT_BEFORE_STOP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_USB3_SUSPHY_BEFORE_QMP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_SEPARATE_SETUP_BUFFER"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_DISABLE_GADGET_IRQ_BEFORE_STOP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_DISABLE_EP0_BEFORE_STOP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_GSI_STOP_STATE"
        );
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_DIRECT");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_DEFER_PULLUP");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_NO_SMMU");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_DMA_CACHE_MAINTENANCE");
        println!(
        ...
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_START_DEFAULTS_AT_RUNSTOP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_MIN_RUNSTOP_DELAY"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_PRESERVE_RUNSTOP"
        );
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_PREV_QMP_GATE");
        ...
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_RESUME_CLOCKS"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_RESUME_CORE_RESET"
        );
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_CORE_HS_CLOCK");
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_FULL_CORE_RESET"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_REAPPLY_RAMCLKSEL"
        );
        ...
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_GADGET_SPEED_AFTER_RESTART"
        );
        println!(
        ...
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_SS_PHY_RESET_RELEASE");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_HSPHY_BEFORE_RESET");
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_HSPHY_RESTORE_SUSPEND_N_AFTER_RUNSTOP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_HSPHY_RESTORE_SUSPEND_N_AFTER_RESET"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_HSPHY_RESTORE_SUSPEND_N_SELECTED_AFTER_RUNSTOP"
        );
        ...
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_HSPHY_PROGRAM_VDDA_VOLTAGE");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_HSPHY_WRITE_BARRIER");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_HSPHY_REF_AFTER_RUNSTOP");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_HSPHY_REF_AFTER_GCTL");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_HSPHY_IGNORE_EUD");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_HSPHY_EUD_DEVICE_MODE");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_DISABLE_EUD");
        println!("cargo:rerun-if-env-changed=FULLERENE_USB_EUD_SCM_FNID");
        println!("cargo:rerun-if-env-changed=FULLERENE_USB_EUD_SCM_SKIP");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_HSPHY_VDD_LPM");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_USB2_SUSPHY_AFTER_RUNSTOP");
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_KEEP_CONNECT_ON_START"
        );
        ...
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_QMP_LANE");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_QMP_PHASE_STOP");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_PROBE_IRQ_ROUTES");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_PROBE_TIMER_EVENT_POLL");
        ...
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_ABL_DEVTEN");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_ABL_EVENT_CONSUME");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_ABL_TRB_FLAGS");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_DCFG_IGNSTRMPP");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_HSPHY_RTUNE");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_DCFG_SUPERSPEED");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_DCFG_FULLSPEED");
        ...
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_DT_HIRD_THRESHOLD"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_EP0_RESET_CALLBACK_FIRST"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_EP0_RESET_CLEAR_STALL"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_EP0_RESET_CLEAR_TEST_MODE"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_EVENT_RING_SIZE_4096"
        );
        println!(
        ...
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_HSPHY_AUTO_RESUME_PULSE");
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SOURCE_EXACT_RUNSTOP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_RUNSTOP"
        );
        ...
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_ANDROID_DBM_RESET"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_CLEAR_QMP_AUTONOMOUS"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_DIS_SLEEP_MODE_BEFORE_GADGET"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_PRESERVE_REF_CLOCK_STATE"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_PRESERVE_PHY_STATE"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_CORE_CLOCKS"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_CORE_CLOCKS_AFTER_RUNSTOP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_DEVICE_MODE"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_DOMAIN_AFTER_RUNSTOP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_LINK_CLOCKS_AFTER_RUNSTOP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_QMP_CLOCKS"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_QMP_CLOCKS_AFTER_GCTL"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_QMP_POWER"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_SS_REASSERT_QMP_POWER_AFTER_GCTL"
        );
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SUSPHY");
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_SUSPHY"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_LONG_SETUP_ARM"
        );
        println!(
        ...
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_DEVTEN_AFTER_RUNSTOP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_PRESERVE_PHY_INTERFACE"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_EXACT_RUNSTOP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_PHY_SETUP"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_RUNTIME_POWER_KEEPALIVE"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_DIS_SLEEP_MODE"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_PERIPHERAL_START"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_VBUS_ONLY"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_SOURCE_POWER_EVENTS"
        );
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_ANDROID_DBM_RESET"
        );
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_USB2_CMD_GUARD");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_XBL_BETWEEN_EP0");
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_XBL_DEFERRED_SETUP"
        );
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_XBL_EP0_CONFIG");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_XBL_EP0_IN_DATA");
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_XBL_EVENT_DMA");
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_XBL_POST_ENDPOINT_GLOBAL"
        );
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_XBL_RAW_RUNSTOP");
        println!(
            "cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_GADGET_HANDOFF_XBL_STOCK_EP0_DMA"
        );
        println!("cargo:rerun-if-env-changed=FULLERENE_AARCH64_USB_PREV_TRACE_GATE");
        println!(
