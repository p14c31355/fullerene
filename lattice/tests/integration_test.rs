...
/// A simple target that wraps a Vec<u32>.
struct TestTarget {
    pixels: Vec<u32>,
    w: u32,
    h: u32,
...
fn test_full_pipeline() {
    ...
    let red_id = wm.create_window(10, 10, 100, 100, 0x0000FF);
    let _blue_id = wm.create_window(60, 60, 100, 100, 0xFF0000);
