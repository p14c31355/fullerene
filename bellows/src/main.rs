...
// Minimal EFI application binary for testing
// This is a simple EFI application that prints a message and halts
// Generated by compiling a minimal Rust EFI application
static KERNEL_EFI_DATA: &[u8] = &[
    ...
    0x50, 0x45, 0x00, 0x00, 0x64, 0x86, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0xF0, 0x00, 0x22, 0x00, 0x0B, 0x02, 0x0E, 0x00, 0x00, 0x04, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x40, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00,
    0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00,
...
pub extern "efiapi" fn efi_main(image_handle: usize, system_table: *mut EfiSystemTable) -> ! {
    ...
    debug_print_str("Bellows: Using embedded kernel data...\n");
    // Use the embedded kernel data instead of reading from file system
    let efi_image_file = KERNEL_EFI_DATA;
    let efi_image_size = KERNEL_EFI_DATA.len();

    if efi_image_size == 0 {
        debug_print_str("Bellows: Embedded kernel data is empty!\n");
        petroleum::println!("Embedded kernel data is empty.");
        panic!("Embedded kernel data is empty.");
    }

    debug_print_str("Bellows: Embedded kernel data loaded.\n");
    petroleum::serial::_print(format_args!("Embedded kernel data loaded. Size: {}\n", efi_image_size));
    ...
    debug_print_str("Bellows: No memory to free (using embedded data).\n");
