...
//!
//! This file documents non‑obvious software bugs encountered during
//! development, their root cause analysis, and the fix applied.
//! Each entry is formatted as a Rust doc‑test so it can be kept in
...
#[cfg(test)]
mod tests {
    // This module exists only for the doc‑test harness; the real
    // navigation logic is tested in solvent::explorer::tests.
}
