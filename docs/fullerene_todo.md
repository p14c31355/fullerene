...
- [x] Native device syscalls: `open_device` resolves PCI, NVMe/AHCI, and registered block identities; `device_ioctl` exposes typed capabilities, PCI access, controller initialization, and block I/O
