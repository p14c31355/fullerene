...
- **Shell and I/O:** a Rust-only launchd (PID 1) manages native user ELF services through the normal process ABI. Its first service is the ordinary userland shell; Nozzle provides line editing, history, built-ins, and command dispatch; Carrier defines terminal and pipeline I/O.
