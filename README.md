...
- **Shell and I/O:** launchd (PID 1) starts the native user ELF shell through the normal process ABI. Nozzle provides line editing, history, built-ins, and command dispatch; Carrier defines terminal and pipeline I/O.
