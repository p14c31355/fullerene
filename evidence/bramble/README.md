...
- [`CONTEXT_STATUS_FULL.md`](CONTEXT_STATUS_FULL.md) — historical status ledger
- [`HARDWARE_BRAMBLE_SUMMARY_FULL.md`](HARDWARE_BRAMBLE_SUMMARY_FULL.md) — legacy cross-platform Bramble table
- [`HARDWARE_aarch64_FULL.md`](HARDWARE_aarch64_FULL.md) — complete AArch64 hardware ledger

Do not load the archive files wholesale into an LLM context. Retrieve a
