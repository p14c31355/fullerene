...
| --- | ---: | --- | --- |
| [`HARDWARE_aarch64_FULL.md`](HARDWARE_aarch64_FULL.md) | 1,650 lines / 662.5 KB | Full Bramble ledger and source audit | Read targeted sections or this index first |
| [`HARDWARE.md`](../../docs/HARDWARE.md) | 926 lines / 418.6 KB | Cross-platform hardware notes plus Bramble summary | Read the Bramble section and this index; avoid loading the full table |
| [`BUG_JOURNAL.md`](../../docs/BUG_JOURNAL.md) | 1,410 lines / 65.7 KB | Historical software investigations, mostly Wi-Fi and runtime | Not needed for the Bramble USB path unless a related regression appears |
| [`ARCHITECTURE.md`](../../docs/ARCHITECTURE.md) | 1,037 lines / 37.9 KB | Project-wide design rules | Read only when changing architecture or ownership boundaries |
| [`BUILD.md`](../../docs/BUILD.md) | 689 lines / 28.8 KB | Build and run procedures | Read the Bramble command section when running hardware |
...
- Full per-run evidence: [`HARDWARE_aarch64_FULL.md`](HARDWARE_aarch64_FULL.md)
- Cross-platform status: [`HARDWARE.md`](../../docs/HARDWARE.md)
- Build commands: [`BUILD.md`](../../docs/BUILD.md)
- Historical non-USB bug records: [`BUG_JOURNAL.md`](../../docs/BUG_JOURNAL.md)
